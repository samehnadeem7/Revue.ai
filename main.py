...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://frontend-jgrjkehnh-samehnadeem7s-projects.vercel.app",  # Latest frontend URL
        "https://frontend-4lrw7rn72-samehnadeem7s-projects.vercel.app",  # Old frontend URL
